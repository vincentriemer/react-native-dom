...
import NativeImageLoaderDOM from './NativeImageLoaderDOM';
...
function getSize(
  ...
  NativeImageLoaderDOM.getSize(uri)
...
function getSizeWithHeaders(
  ...
  return NativeImageLoaderDOM.getSizeWithHeaders(uri, headers)
    .then(function(sizes) {
...
function prefetch(url: string): any {
  return NativeImageLoaderDOM.prefetchImage(url);
}

async function queryCache(
  urls: Array<string>,
): Promise<{[string]: 'memory' | 'disk' | 'disk/memory', ...}> {
  return await NativeImageLoaderDOM.queryCache(urls);
}
